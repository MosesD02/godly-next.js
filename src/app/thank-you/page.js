  ...
  return (
    <WebsiteLayout footerForm={false}>
      <section className="flex flex-1 flex-col items-center justify-center px-6 py-20 text-center md:py-28">
        <h1 className="trim text-[clamp(64px,16vw,200px)] leading-[0.9] text-white">
          THANK YOU
        </h1>
        ...
        <Button asChild className="quote-button mt-12">
          <Link href="/">
            <span className="color-[#fde4c8]! trim z-10">Back to Home</span>
            <svg
              ...
              viewBox="0 0 33 33"
              fill="none"
              className="z-10 size-6 md:size-7.5"
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M18.142 24.1284C18.3035 24.2631 18.4898 24.3646 18.6905 24.4272C18.8912 24.4898 19.1023 24.5122 19.3117 24.4932C19.521 24.4742 19.7246 24.4141 19.9107 24.3163C20.0968 24.2186 20.2619 24.0852 20.3964 23.9236L25.7292 17.5236C25.8697 17.363 25.9766 17.176 26.0438 16.9735C26.1109 16.771 26.1368 16.5571 26.1201 16.3444C26.1033 16.1317 26.0442 15.9245 25.9461 15.735C25.8481 15.5455 25.7132 15.3775 25.5493 15.241C25.3854 15.1044 25.1958 15.002 24.9918 14.9397C24.7877 14.8775 24.5733 14.8567 24.361 14.8785C24.1488 14.9004 23.9431 14.9645 23.756 15.067C23.5689 15.1696 23.4042 15.3085 23.2716 15.4756L17.9372 21.8756C17.6658 22.2016 17.5348 22.622 17.5732 23.0444C17.6116 23.4669 17.8162 23.8568 18.142 24.1284Z"
                fill="#FDE7CD"
              />
              <path
                fillRule="evenodd"
