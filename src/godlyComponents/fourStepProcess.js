...
const FourStepProcess = () => {
  ...
  const getCitySpecificContent = () => {
    if (city === "PARKLAND") {
      return {
        mainHeading:
          "Our Exclusive RainShield™ Glass Shielding System in Parkland",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "FORT LAUDERDALE") {
      return {
        mainHeading:
          "Our Exclusive RainShield™ Glass Shielding System in Fort Lauderdale",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "LIGHTHOUSE POINT") {
      return {
        mainHeading:
          "Spot-Free Window Protection with Our RainShield™ System in Lighthouse Point",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "SOUTHWEST RANCHES") {
      return {
        mainHeading:
          "Advanced RainShield™ Window Treatment for Southwest Ranches Homes",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "CORAL SPRINGS") {
      return {
        mainHeading:
          "RainShield™ Window Protection Tailored for Coral Springs Weather",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "HALLANDALE BEACH") {
      return {
        mainHeading:
          "Coastal-Grade RainShield™ Glass Protection for Hallandale Beach Homes",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "MARGATE") {
      return {
        mainHeading:
          "Our Signature RainShield™ Glass Protection for Homes in Margate",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "PEMBROKE PINES") {
      return {
        mainHeading:
          "RainShield™-Enhanced Glass Cleaning Designed for Pembroke Pines",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "HILLSBORO BEACH") {
      return {
        mainHeading:
          "RainShield™ Glass Protection Built for Coastal Homes in Hillsboro Beach",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "PLANTATION") {
      return {
        mainHeading:
          "RainShield™ Glass Care for Long-Lasting Clarity in Plantation",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "TAMARAC") {
      return {
        mainHeading:
          "RainShield™ Window Protection Engineered for Tamarac Weather",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "DEERFIELD BEACH") {
      return {
        mainHeading:
          "RainShield™ Window Protection for Coastal & Inland Homes in Deerfield Beach",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "HOLLYWOOD") {
      return {
        mainHeading:
          "RainShield™ Window Protection Tailored for Hollywood's Coastal Climate",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "MIRAMAR") {
      return {
        mainHeading:
          "RainShield™ Window Protection Designed for Miramar's Climate",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "POMPANO BEACH") {
      return {
        mainHeading:
          "RainShield™ Glass Protection for Pompano Beach's Coastal Conditions",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "LAUDERDALE-BY-THE-SEA") {
      return {
        mainHeading:
          "RainShield™ Glass Protection for Salt-Exposed Homes in Lauderdale-by-the-Sea",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "OAKLAND PARK") {
      return {
        mainHeading:
          "RainShield™ Window Protection Built for Oakland Park Homes & Businesses",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "WESTON") {
      return {
        mainHeading:
          "RainShield™ Glass Care for Weston's Clean, Green Neighborhoods",
        steps: [
          {
            number: "01",
            title: "Scrub",
    ...
    if (city === "ROYAL PALM BEACH") {
      return {
        mainHeading:
          "RainShield™ Window Protection Tailored for Royal Palm Beach Homes",
        steps: [
          {
            number: "01",
            title: "Scrub",
      ...
      {sparks && (
        <>
          <Image
            ...
            src={image}
            className={cn(
              "absolute -top-1 left-0.5 size-2.5 rotate-15 object-contain opacity-0 transition-all duration-300 ease-in-out group-hover:opacity-100",
