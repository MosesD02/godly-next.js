...
export const getCityHomepageFaqs = (cityName) => [
  {
    ...
    answer: `In ${cityName}, we offer window cleaning (interior, exterior, and full), Rain Shield coating, post-construction cleaning, house washing, roof washing, gutter cleaning, soft washing, screen cleaning, and holiday light installation. Every service is tailored to South Florida conditions.`,
  },
  {
    question: `How quickly can you get to my ${cityName} home?`,
    answer: `Most ${cityName} jobs get scheduled within 3–5 business days of your estimate. For urgent requests — storm cleanup, real estate listings, or event prep — we'll do everything we can to fit you in sooner.`,
  },
  {
    question: "Are you licensed, insured, and bonded?",
    answer:
  ...
  },
  {
    ...
    answer: `Yes — every estimate is free and comes with zero pressure. You can book online, call us directly, or request a quote through our site. Most ${cityName} estimates come back the same day you reach out.`,
  },
];
