  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="absolute bottom-1 left-1/2 max-w-[115px] shrink-0 -translate-x-1/2">
            ...
            <div
              ...
              style={{ backgroundImage: `url(${grainBg.src})` }}
            >
              <div className="flex h-full w-full flex-col justify-between rounded-[6px] border-[0.4px] border-black p-[5px]">
