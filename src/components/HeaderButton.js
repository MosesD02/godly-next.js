  ...
  return (
    <>
      ...
      >
        <div>
          <div
            className="shadow-[0px 1px 1px 0px rgba(0, 0, 0, 0.25) inset, 0px -1px 1.2px 0px rgba(255, 255, 255, 0.03), 0px 2px 2.6px 0px rgba(0, 0, 0, 0.30)] relative h-[14.4px] w-32 rounded-[3px] border-[0.4px] border-black bg-[#1b1b1b] bg-repeat"
            style={{ backgroundImage: `url(${grainBg.src})` }}
          >
            <div className="absolute bottom-1 left-1/2 max-w-[115px] shrink-0 -translate-x-1/2 transition-all duration-300">
              ...
              <div
                ...
                style={{ backgroundImage: `url(${grainBg.src})` }}
              >
                <div className="flex h-full w-full flex-col justify-between rounded-[6px] border-[0.4px] border-black p-[5px] transition-all duration-300">
