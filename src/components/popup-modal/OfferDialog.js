...
const OFFER_CLOSE_CLASS =
  "!top-3 !right-3 !z-120 !flex !min-h-11 !min-w-11 !items-center !justify-center !bg-transparent md:!top-4 md:!right-4 md:[&_svg]:!size-6.75 [&_svg]:!size-5";

const OFFER_CONTENT_CLASS =
  "z-100! flex aspect-1811/2711 min-h-168.75 max-w-110 max-sm:scale-[0.86] scale-90 flex-col gap-0 overflow-hidden border-0 bg-transparent bg-[url(/assets/UnionMobile.png)] bg-contain bg-center bg-no-repeat px-12 shadow-none md:max-w-110 md:scale-100 md:bg-[url(/assets/Union.png)] md:px-8";
...
export function OfferDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent closeClass={OFFER_CLOSE_CLASS} className={OFFER_CONTENT_CLASS}>
        ...
        <div className="flex min-h-0 w-full min-w-0 flex-1 flex-col">
          ...
          <div
            className={OFFER_DASHED_RULE_CLASS}
            aria-hidden
          />
